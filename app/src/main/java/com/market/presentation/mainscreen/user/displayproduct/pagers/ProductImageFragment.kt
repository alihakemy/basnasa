package com.market.presentation.mainscreen.user.displayproduct.pagers
 ...
 * Use the [ProductImageFragment.newInstance] factory method to
...
class ProductImageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val imageView10 = view.findViewById<ImageView>(R.id.productImage)
